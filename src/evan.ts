...
import {util, isSemanticsTyped} from "./metamodel";
...
export function polyEval(json: any, values: util.IDictionary, functionTable: util.IDictionary, objectTable: util.IDictionary): any {
